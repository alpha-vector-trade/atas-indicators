...
public class SessionColorExtended : Indicator
{
    ...
    [Display(ResourceType = typeof(Resources), Name = "ShowStartOnly", GroupName = "Settings", Order = 30)]
    ...
    [Range(1, 20)]
    [Display(ResourceType = typeof(Resources), Name = "LineWidth", GroupName = "Settings", Order = 50)]
    ...
    [Display(ResourceType = typeof(Resources), Name = "StartTime", GroupName = "Settings", Order = 60)]
    ...
    [Display(ResourceType = typeof(Resources), Name = "EndTime", GroupName = "Settings", Order = 70)]
    ...
    protected override void OnRender(RenderContext context, DrawingLayouts layout)
    {
        lock (_syncRoot)
        {
            ...
            foreach (var session in _sessions)
            {
                ...
                {
                    var pen = new RenderPen(_areaColor, _lineWidth);
